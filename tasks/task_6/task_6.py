...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        embedding_client = EmbeddingClient(embed_config['model_name'],
                                           embed_config['project'],
                                           embed_config['location'])
        # 3) Initialize the ChromaCollectionCreator from Task 5
        ####### YOUR CODE HERE #######
        chroma_collection = ChromaCollectionCreator(document_processor, embedding_client)
        ...
        with st.form("Load Data to Chroma"):
            ...
            question_topic = st.text_input("Topic for Generative Quiz")
            # 4) for the quiz topic and the desired number of questions
            num_question = st.slider("Number of Questions", 1, 10, 5)
            ####### YOUR CODE HERE #######
            document = None
            ...
            if submitted:
                ...
                document = chroma_collection.query_chroma_collection(question_topic)
